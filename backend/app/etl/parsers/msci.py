...
class MSCIParser(BaseParser):
    """MSCI / Real Capital Analytics export format parser."""
    source_type = "msci"

    column_map = {
        "property_name":    ["Property Name", "Asset Name"],
        "street":           ["Street", "Address", "Property Street"],
        "city":             ["City", "Property City"],
        "state":            ["State", "Property State"],
        "zip":              ["Zip", "Zip Code"],
        "county":           ["County", "Property County"],
        "submarket":        ["Submarket", "Market Area"],
        "units":            ["Units", "No. Units", "Number Units"],
        "year_built":       ["Year Built", "Built Year"],
        "building_class":   ["Class", "Quality Class"],
        "property_type":    ["Property Type", "Asset Type"],
        "owner_name":       ["Buyer", "Current Owner", "Owner"],
        "lender":           ["Lender Name", "Lender"],
        "originator":       ["Originator"],
        "servicer":         ["Servicer"],
        "origination_date": ["Loan Date", "Closing Date", "Origination Date"],
        "maturity_date":    ["Maturity Date", "Loan Maturity"],
        "original_amount":  ["Loan Amount", "Original Amount", "Debt Amount"],
        "current_balance":  ["Current Balance", "Outstanding Balance"],
        "rate_type":        ["Rate Type", "Loan Type Rate"],
        "coupon":           ["Rate", "Coupon", "Interest Rate"],
        "io_flag":          ["IO", "Interest Only"],
        "loan_type":        ["Loan Type"],
        "recourse":         ["Recourse"],
