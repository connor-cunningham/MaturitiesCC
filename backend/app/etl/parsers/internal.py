...
class InternalParser(BaseParser):
    ...
    column_map = {
        ...
        "owner_name":       ["Owner", "Borrower", "Sponsor", "Owner Name"],
        "lender":           ["Lender", "Bank", "Lender Name"],
        "originator":       ["Originator"],
        "servicer":         ["Servicer"],
        "origination_date": ["Origination Date", "Orig Date", "Close Date"],
        "maturity_date":    ["Maturity Date", "Maturity", "Due Date"],
        "original_amount":  ["Original Balance", "Loan Amount", "Original Loan Amount"],
        "current_balance":  ["Current Balance", "UPB", "Outstanding Balance"],
        "rate_type":        ["Rate Type"],
